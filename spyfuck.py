...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/SPY1×100/game.py/main/game.txt').text
...
|/     \||/     \|\_______/|/    )_)(_______)|/   \__/
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : AMINUR HARMAN            │
    │ [✓] GITHUB   : AMINUR69                │
    │ [✓] WHATSAPP : +8801878410686        │
    │ [✓] VERSION  : 13.1                 │
    │ [✓] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m NAMTA MONE RAKHBEN VIRUS TEAM-FUCK & ANONYMOUS CYBER ™ \033[1;37m ")
      sys.exit()
  except:
    sys.exit()
    if name == '__main__':
